              ...
              <div className='profile-image-div'>
                <div className='image-name-container'>
                  <div className='image-con'>
                    ...
                    {sessionUser.picUrl === 'https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/73-730477_first-name-profile-image-placeholder-png.png' && <Link className='add-profile-photo' to='profile/edit'><i className="fa-solid fa-plus profile-img">Add photo</i></Link>}
                  </div>
