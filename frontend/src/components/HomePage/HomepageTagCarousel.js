        ...
        <div className='homepage-tag-div'>
          <div className='homepage-tag-movement' style={{ transform: `translateX(-${activeIndex * 1280}px)`}}>
            ...
            <Link to={`/skateparks/Pool`} className='homepage-tag-grid'>
              ...
              <div className='homepage-tag-img-divs'><img src='https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/Ulysses-Skate-Park_SpeakEasy-Colorado-Skate-Park-Directory-1.jpg' alt='skate-pool' className='homepage-tag-street'/></div>
            </Link>
            <Link to={`/skateparks/Snake Run`} className='homepage-tag-grid'>
              <div className='homepage-tags-titles'>Snake Run</div>
              <div className='homepage-tag-img-divs'><img src='https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/04698E53-99A2-47D8-B0BA-3535DF6699BC.jpeg' alt='snake-run' className='homepage-tag-pump'/></div>
            </Link>
            <Link to={`/skateparks/Street`} className='homepage-tag-grid'>
              <div className='homepage-tags-titles'>Street</div>
              <div className='homepage-tag-img-divs'><img src='https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/8BA0D085-E615-4DEB-9A43-F6D26E22F1A8.png' alt='street-skate' className='homepage-tag-pump'/></div>
            </Link>
            <Link to={`/skateparks/Rails`} className='homepage-tag-grid'>
              <div className='homepage-tags-titles'>Rails</div>
              <div className='homepage-tag-img-divs'><img src='https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/Ulysses-Skate-Park_SpeakEasy-Colorado-Skate-Park-Directory-1.jpg' alt='rails' className='homepage-tag-pump'/></div>
            </Link>
            <Link to={`/skateparks/Ledges`} className='homepage-tag-grid'>
              <div className='homepage-tags-titles'>Ledges</div>
              <div className='homepage-tag-img-divs'><img src='https://drop-in-skate-bucket.s3.us-west-1.amazonaws.com/BC6FF45E-B805-466D-9161-C5F7FE504033.jpeg' alt='ledges' className='homepage-tag-pump'/></div>
            </Link>
