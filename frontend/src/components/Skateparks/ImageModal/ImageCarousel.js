  ...
  return (
    <div className='modal-img-page'>
      {skatepark ?
          <div id='modal-img-container'>
            ...
            <div className='modal-img-div'>
              <div className='modal-img-movement' style={{ transform: `translateX(-${activeIndex * 100}%)`}}>
      ...
      <div className='circle-div'>
        {skatepark.images.map((img, index) => {
          return (<div className={activeIndex === index ? 'img-circle active-circle' : 'img-circle'} key={index}></div>);
        })}
      </div>
    </div>
  );
